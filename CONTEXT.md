...
| File | Description |
|------|-------------|
| [`ARCHITECTURE.html`](ARCHITECTURE.html) | ARCHITECTURE.html — generated by core/tools/wos/diagram/architecture from core/features.txt and the generated routing blocks. Do not edit: run the tool. |
