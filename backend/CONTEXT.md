...
| [`claude.py`](claude.py) | — | `parse_events`, `ClaudeBackend`, `build_args`, `last_response`, `env` | claude.py — ClaudeBackend: normalizes `claude -p --output-format json` (single result object). |
